...
public class InitialParamsWindowController {
    ...
    @FXML
    private Spinner<Double> plantEnergySpinner;

    @FXML
    private Spinner<Double> moveEnergySpinner;
    ...
    void initialize() {
        ...
        assert initialEnergySpinner != null : "fx:id=\"initialEnergySpinner\" was not injected: check your FXML file 'initialParamsWindow.fxml'.";
        ...
        plantEnergySpinner.setValueFactory(new SpinnerValueFactory.DoubleSpinnerValueFactory(0, 100,50));
        moveEnergySpinner.setValueFactory(new SpinnerValueFactory.DoubleSpinnerValueFactory(0, 100,10));
        ...
        initialEnergySpinner.setValueFactory(new SpinnerValueFactory.DoubleSpinnerValueFactory(0,100,50));
    }
